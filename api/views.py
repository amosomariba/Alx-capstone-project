...
def initiate_payment(amount, email, order_id): # Payment Function From Flutterwave will give us a unique link after payment
    ...
    try:
        response = requests.post(url, headers=headers, json=data) # Unique Link is generated after making payments
...
class OrderViewSet(ModelViewSet):
    ...
    @action(detail=True, methods=["POST"]) # Is used to call payment function in the Flutterwave
    ...
    @action(detail=False, methods=["POST"]) # Is used to confirm payment in Flutterwave
